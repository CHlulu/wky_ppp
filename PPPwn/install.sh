...
WKYIP=$(tr -d '\0' </proc/device-tree/model) 
if [[ $WKYIP == *"Xunlei OneCloud"* ]] ;then
while true; do
read -p "$(printf '\r\n\r\n\033[36mDo you want the WKY to act as a flash drive to the console\r\n\r\n\033[36m(Y|N)?: \033[0m')" vusb
case $vusb in
[Yy]* ) 
...
sudo cp "/root/WKY-Pwn/USB Drive/goldhen.bin" /media/pwndev
...
echo -e '\033[32mThe WKY will mount as a drive and goldhen.bin has been placed in the drive\n\033[33mYou must plug the WKY into the console usb port using the usb-c of the WKY\033[0m'
VUSB="true"
break;;
[Nn]* ) 
echo -e '\033[35mThe WKY will not mount as a drive\033[0m'
VUSB="false"
break;;
* ) echo -e '\033[31mPlease answer Y or N\033[0m';;
esac
